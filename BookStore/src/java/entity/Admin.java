...
public class Admin {
    ...
    private String lockReason; // [MỚI]
    private Timestamp lockedAt; // [MỚI]
    private String salt; // [MỚI]

    public Admin() {
    }

    // Constructor đầy đủ
    public Admin(int id, String name, String email, String contact, String gender, 
