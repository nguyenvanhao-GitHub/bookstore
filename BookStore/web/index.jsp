            ...
            <section id="Featuredbooks" class="new-books-section">
                <div class="container">
                    ...
                    <div class="pagination-container">
                        ...
                        <div class="page-info">
                            <%= LanguageHelper.getText(request, "page")%> <%= currentPage%> <%= LanguageHelper.getText(request, "of_page")%> <%= totalPages%> (<%= LanguageHelper.getText(request, "total")%> <%= totalBooks%> <%= LanguageHelper.getText(request, "books")%>)
                        </div>
                    </div>
                    <% }%>
                </div>
